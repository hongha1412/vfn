<div class="panel-body">
    <div class="form-inline" style="padding-bottom: 10px">
        ...
        <div class="form-group pull-right">
            ...
            <input type="search" class="form-control" id="search" placeholder="Tìm kiếm theo name" v-model="paginationVipCmt.search_key" @keyup.enter="searchVipCmt()">
        </div>
    </div>
        ...
        <table id="vip-cmt" class="table table-bordered table-striped">
            ...
            <tbody>
                <tr v-for="item in itemsVipCmt">
                    ...
                    <td>
                        <a href="javascript:void(0);" @click.prevent="showConfirmDelete('vipcmt', item.id)" class="btn btn-xs btn-danger"><i class="fa fa-user-times" aria-hidden="true"></i> Xóa Tài Khoản</a>
            ...
            <ul class="pagination">
                <li v-if="paginationVipCmt.current_page > 1">
                    <a href="#" aria-label="Previous"
                       @click.prevent="changePageVipCmt(paginationVipCmt.current_page - 1, paginationVipCmt.per_page)">
                ...
                <li v-for="page in pagesNumberVipCmt"
                    ...
                    <a href="#"
                       @click.prevent="changePageVipCmt(page, paginationVipCmt.per_page)">@{{ page }}</a>
                </li>
