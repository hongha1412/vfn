                              ...
                              <tr>
                                 <td bgcolor="#F3F3F3" width="100%" style="background-color:#f3f3f3;padding:12px;border-bottom:1px solid #ececec">
                                    <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;width:100%!important;font-family:Helvetica,Arial,sans-serif;min-width:100%!important" width="100%">
                                       <tbody>
                                          <tr>
                                             <td align="left" valign="middle" width="50%"><span style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">LikeFB.Pro</span></td>
                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                        ...
                                                                        <p style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">Bạn vừa đăng ký thành công tài khoản <b>'.$username.'</b> tại hệ thống , vui lòng xác mình vào liên kết phía giới để kích hoạt tài khoản của bạn hoặc nhấn <a href="http://likefb.pro/xacminh?code='.$code.'">vào đây để xác minh</a></p>
