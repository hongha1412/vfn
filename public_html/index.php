...
<p><b>MỌI THẮC MẮC LIÊN HỆ ADMIN</b></p></center>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="https://www.facebook.com/doduythinh18" class="btn btn-default btn-flat">Liên Hệ</a>
                </div>
...
?>/canhan" class="btn btn-default btn-flat"><i class="fa fa-fw fa-user"></i> Cá Nhân</a>
                ...
                <div class="pull-right">
                  <a href="<?
        $home;
?>/chagepass.php" class="btn btn-default btn-flat"><i class="fa fa-fw fa-lock"></i> Đổi Pass</a>
                </div>
              </li>
            </ul>
          </li>
            ...
            <ul class="sidebar-menu">
                <li class="active Home"><a href="/"><i class="fa fa-home" style="color: #00a65a;"></i> <span>TRANG CHỦ</span></a></li>
                     ...
                     <li><a href="/dangky.php"><i class="fa fa-user-plus" aria-hidden="true"></i> <span>Đăng Ký</span></a></li>
                           <li><a data-toggle="modal" data-target="#DANGNHAP"><i class="fa fa-user" aria-hidden="true"></i> <span>Đăng Nhập</span></a></li>
						    <li><a href="/get_token.php"><i class="fa fa-share" aria-hidden="true"></i> <span>Get Token</span></a></li>
							<li><a href="/banggia.php"><i class="fa fa-calculator" aria-hidden="true"></i> <span>BẢNG GIÁ</span></a></li> 
                           <li><a href="https://www.facebook.com/doduythinh18"><i class="fa fa-support" aria-hidden="true"></i> <span>Liên Hệ</span></a></li>
<?php
    } else {
?>
                           <img src="<?
...
<div class="alert alert-danger">
     <strong><marquee>Server Vip Like Hoạt Động Ổn Định Nhất Hiện Nay</marquee></strong>   
</div>
...
<div class="row"> 
    ...
    $home;
?>/theme/img/performance-icon-256.png" alt="" class="et-waypoint et_pb_animation_off et-animated"></div>
                <div class="et_pb_blurb_container">
                    <h4>Công nghệ mới</h4>

                    <p>Tăng Like tự động không bị tụt. Không cần phải online cũng tăng được , giúp giảm thời gian của bạn hiệu quả hơn.</p>
    ...
    <div class="col-sm-4">
     <div class="box box-solid">
            <div class="card panel-body text-center">
                <div class="et_pb_main_blurb_image"><img width="100px" src="<?php
    $home;
?>/theme/img/icon-document.png" alt="" class="et-waypoint et_pb_animation_off et-animated"></div>
                <div class="et_pb_blurb_container">
                    <h4>Chi phí thấp</h4>

                    <p>Giá hầu như rất vừa với túi tiền của các bạn nên rất được ưa chuông dịch vụ này và được duy trì lâu dài và hiệu quả.</p>
    ...
    <div class="col-sm-4">
     <div class="box box-solid">
            <div class="card panel-body text-center">
                <div class="et_pb_main_blurb_image"><img width="100px" src="<?php
    $home;
?>/theme/img/vps-security-icon.png" alt="" class="et-waypoint et_pb_animation_off et-animated"></div>
                <div class="et_pb_blurb_container">
                    <h4>Bảo Vệ Nick An Toàn</h4>

                    <p>Chúng tôi không yêu cầu token của bạn giúp bạn bảo mật và an toàn cho tài khoản Facebook của bạn.</p>
    ...
    <div class="modal-dialog modal-col-sm-4">
      <div class="modal-content">
        ...
        <div class="form-group">
            <p><li class="list-group-item">ID Thành Viên : <b style="color:red">#<?php
echo $_SESSION['user'];
?></b>
            </li></p>
            <p><li class="list-group-item">Tên Đầy Đủ : <b style="color:red"><?php
echo $user['fullname'];
?></b>
            </li></p>
            <p><li class="list-group-item">E-mail : <b style="color:red"><?php
echo $user['mail'];
?></b>
            </li></p>	
            <p><li class="list-group-item">Số Điện Thoại : <b style="color:red"><?php
echo $user['sdt'];
?></b>
            </li></p>
			<p><li class="list-group-item">Số Dư : <b style="color:red"><?php
echo number_format($user['vnd'], 0, ',', ',');
?> VNĐ</b>
            </li></p>			
			<p><li class="list-group-item">Tài Khoản : <b style="color:red"><?php
echo $user['username'];
?></b>
            </li></p>
			</div>
...
<table class="table table-bordered"><thead><tr class="active"><th><center>Tên Gói Vip</center></th><th><center><font color="red">VNĐ / Tháng</font></center></th></tr></thead><tbody>									
				<tr><td><center>15 Comment</center></td><td><center><?php
echo number_format(30000);
?> VNĐ</center></td></tr>
				<tr><td><center>20 Comment</center></td><td><center><?php
echo number_format(60000);
?> VNĐ</center></td></tr>
				<tr><td><center>25 Comment</center></td><td><center><?php
echo number_format(100000);
?> VNĐ</center></td></tr>
				<tr><td><center>30 Comment</center></td><td><center><?php
echo number_format(140000);
?> VNĐ</center></td></tr>
				<tr><td><center>35 Comment</center></td><td><center><?php
echo number_format(170000);
?> VNĐ</center></td></tr>
				<tr><td><center>40 Comment</center></td><td><center><?php
echo number_format(200000);
?> VNĐ</center></td></tr>
				<tr><td><center>45 Comment</center></td><td><center><?php
...
<div class="modal fade" id="gialike" role="dialog">
    <div class="modal-dialog modal-col-sm-4">
      <div class="modal-content">
        ...
        <div class="modal-body">
<table class="table table-bordered"><thead><tr class="active"><th><center>Tên Gói Vip</center></th><th><center><font color="red">VNĐ / Tháng</font></center></th></tr></thead><tbody>									
				<tr><td><center>150 Like</center></td><td><center><?php
echo number_format(30000);
?> VNĐ</center></td></tr>
				<tr><td><center>300 Like</center></td><td><center><?php
echo number_format(50000);
?> VNĐ</center></td></tr>
				<tr><td><center>500 Like</center></td><td><center><?php
echo number_format(80000);
?> VNĐ</center></td></tr>
				<tr><td><center>700 Like</center></td><td><center><?php
echo number_format(120000);
?> VNĐ</center></td></tr>
				<tr><td><center>1000 Like</center></td><td><center><?php
echo number_format(170000);
?> VNĐ</center></td></tr>
				<tr><td><center>1500 Like</center></td><td><center><?php
echo number_format(250000);
?> VNĐ</center></td></tr>
				<tr><td><center>2000 Like</center></td><td><center><?php
