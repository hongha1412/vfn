...
<label>Số CMT/1 Phút</label>         
        ...
        <div class="form-group">
<label>Nội Dung CMT</label><textarea class="form-control" id="noidung" name="noidung" rows="5" placeholder="Nhập nội dung tương ứng với số cmt bạn mua" required="" autofocus=""></textarea>
                        </div>
                     <div class="form-group">
...
<td><?php echo $cmt[$res['goi']]; ?> Like</td>
