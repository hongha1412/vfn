...
new Vue({
    ...
    methods: {
        getPackageList: function getPackageList(page, per_page) {
            ...
            this.$http.get('/api/package?page=' + page + '&perPage=' + per_page).then(function (response) {
                if (response) {
        ...
        postPackage: function postPackage() {
            ...
            this.$http.post('/api/package', input).then(function (response) {
                _this2.getPackageList(_this2.pagination.current_page, _this2.pagination.per_page);
                _this2.fillItem = { 'total': '', 'type': '', 'id': '' };
        ...
        update: function update(id) {
            ...
            var input = this.fillItem;
            this.$http.put('/api/package/' + id, input).then(function (response) {
                _this3.getPackageList(_this3.pagination.current_page, _this3.pagination.per_page);
                _this3.fillItem = { 'total': '', 'type': '', 'id': '' };
        ...
        remove: function remove($id) {
            ...
            this.$http.delete('/api/package/' + $id).then(function (response) {
                _this4.getPackageList(_this4.pagination.current_page, _this4.pagination.per_page);
                _this4.fillItem = { 'total': '', 'type': '', 'id': '' };
