...
new Vue({
    ...
    methods: {
        getSpeedList: function getSpeedList(page, per_page) {
            var _this = this;

            this.$http.get('/api/speed?page=' + page + '&perPage=' + per_page).then(function (response) {
                if (response) {
        ...
        postSpeed: function postSpeed() {
            ...
            this.$http.post('/api/speed', input).then(function (response) {
                _this2.getSpeedList(_this2.pagination.current_page, _this2.pagination.per_page);
                _this2.fillItem = { 'value': '', 'type': '', 'id': '' };
        ...
        update: function update(id) {
            ...
            var input = this.fillItem;
            this.$http.put('/api/speed/' + id, input).then(function (response) {
                _this3.getSpeedList(_this3.pagination.current_page, _this3.pagination.per_page);
                _this3.fillItem = { 'value': '', 'type': '', 'id': '' };
        ...
        remove: function remove($id) {
            ...
            this.$http.delete('/api/speed/' + $id).then(function (response) {
                _this4.getSpeedList(_this4.pagination.current_page, _this4.pagination.per_page);
                _this4.fillItem = { 'value': '', 'type': '', 'id': '' };
